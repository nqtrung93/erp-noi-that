...
// Factory tạo controller CRUD cho 1 bảng đơn giản (#15).
// columns: các cột cho phép ghi (whitelist để tránh SQL injection vào tên cột).
export function makeCrud(table, columns) {
