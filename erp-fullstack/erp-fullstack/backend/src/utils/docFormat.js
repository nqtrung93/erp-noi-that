...
export const DEFAULT_DOC_FORMATS = {
  ...
  inbound: { label: "Phiếu nhập hàng", prefix: "PN", pad: 6, seq: "inbound_seq" },
  adjust: { label: "Phiếu điều chỉnh tồn", prefix: "PDC", pad: 6, seq: "adjust_seq" },
  transfer: { label: "Phiếu luân chuyển kho", prefix: "PXK", pad: 6, seq: "transfer_seq" },
  saleout: { label: "Phiếu xuất hàng (xuất bán)", prefix: "PXH", pad: 6, seq: "saleout_seq" },
  transaction: { label: "Phiếu thu/chi", prefix: "TX", pad: 6, seq: "tx_seq" },
  warranty: { label: "Phiếu bảo hành", prefix: "BH", pad: 6, seq: "warranty_seq" },
};
...
// Sinh số phiếu kế tiếp cho 1 loại, dùng client đang trong transaction (nếu có) để atomic với sequence.
